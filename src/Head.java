...
//        spriteList.add(image5);
        ...
        ImageIcon icon = new ImageIcon("Heads/Head1-1.png");
...
//        java.awt.Image newImage = image;
        spriteList.add(icon);
        ImageIcon icon2 = new ImageIcon("Heads/Head2-1.png");
        spriteList.add(icon2);
        ImageIcon icon3 = new ImageIcon("Heads/Head3-1.png");
        spriteList.add(icon3);
        ImageIcon icon4 = new ImageIcon("Heads/Head4-1.png");
        spriteList.add(icon4);
        ImageIcon icon5 = new ImageIcon("Heads/Head5-1.png");

...
//        spriteList.add(image2);
    ...
    protected void createSpriteList() {
        //Path
        ImageIcon icon = new ImageIcon("/Users/zazu/IdeaProjects/Comp221Project/Nose/Nose1-1.png");
        spriteList.add(icon);

        ImageIcon icon2 = new ImageIcon("/Users/zazu/IdeaProjects/Comp221Project/Nose/Nose2-1.png");
        spriteList.add(icon2);

        ImageIcon icon3 = new ImageIcon("/Users/zazu/IdeaProjects/Comp221Project/Nose/Nose3-1.png");
        spriteList.add(icon3);

        ImageIcon icon4 = new ImageIcon("/Users/zazu/IdeaProjects/Comp221Project/Nose/Nose4-1.png");
        spriteList.add(icon4);

        ImageIcon icon5 = new ImageIcon("/Users/zazu/IdeaProjects/Comp221Project/Nose/Nose5-1.png");
...
//        //Relative Path
//        ImageIcon icon = new ImageIcon("Nose/Nose1-1.png");
//        spriteList.add(icon);
//
//        ImageIcon icon2 = new ImageIcon("Nose/Nose2-1.png");
//        spriteList.add(icon2);
//
//        ImageIcon icon3 = new ImageIcon("Nose/Nose3-1.png");
//        spriteList.add(icon3);
//
//        ImageIcon icon4 = new ImageIcon("Nose/Nose4-1.png");
//        spriteList.add(icon4);
//
